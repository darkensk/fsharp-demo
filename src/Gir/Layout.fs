    ...
    header
        ...
        [ div [ _class "nav-close" ] [ i [ _class "fa fa-close"; _ariaHidden "true" ] [] ]
          ...
          div
              ...
              [ a [ _href "#"; _class "btn amado-btn mb-15" ] [ str "%Discount%" ]
                a [ _href "#"; _class "btn amado-btn active" ] [ str "New this week" ] ]
          div
              [ _class "cart-fav-search mb-100" ]
              [ a
                    [ _href "/cart/"; _class "cart-nav" ]
                    [ img [ _src "/img/core-img/cart.png"; _alt "" ]
                      str "Cart "
                      span [] [ str cartSizeString ] ]
                a
                    [ _href "#"; _class "fav-nav" ]
                    [ img [ _src "/img/core-img/favorites.png"; _alt "" ]; str "Favourite" ]
                a
                    [ _href "/settings/"; _class "fav-nav" ]
                    [ img
                          [ _style "width: 20px; height: 20px;"
...
let footerView =
    footer
        ...
        [ div
              [ _class "container" ]
              [ div
                    [ _class "row align-items-center" ]
                    [ div
                          [ _class "col-12 col-lg-4" ]
                          [ div
                                [ _class "single_widget_area" ]
                                [ div
                                      [ _class "footer-logo mr-50" ]
                                      [ a [ _href "/" ] [ img [ _src "/img/core-img/logo2.png"; _alt "" ] ] ]
                                  p
                                      [ _class "copywrite" ]
                                      [ str "Copyright ©"
                                        ...
                                        str " by "
                                        a [ _href "https://colorlib.com"; _target "_blank" ] [ str "Colorlib" ] ] ] ]
                      div
                          ...
                          [ div
                                ...
                                [ div
                                      [ _class "footer_menu" ]
                                      [ nav
                                            [ _class "navbar navbar-expand-lg justify-content-end" ]
                                            [ button
                                                  ...
                                                  [ i [ _class "fa fa-bars" ] [] ]
                                              div
                                                  [ _class "collapse navbar-collapse"; _id "footerNavContent" ]
                                                  [ ul
                                                        [ _class "navbar-nav ml-auto" ]
                                                        [ li
                                                              [ _class "nav-item active" ]
                                                              [ a [ _class "nav-link"; _href "/" ] [ str "Home" ] ]
                                                          li
                                                              [ _class "nav-item" ]
                                                              [ a [ _class "nav-link"; _href "/" ] [ str "Shop" ] ]
                                                          li
                                                              [ _class "nav-item" ]
                                                              [ a [ _class "nav-link"; _href "/" ] [ str "Product" ] ]
                                                          li
                                                              [ _class "nav-item" ]
                                                              [ a [ _class "nav-link"; _href "/cart/" ] [ str "Cart" ] ]
                                                          li
                                                              [ _class "nav-item" ]
                                                              [ a
    ...
    section
        ...
        [ div
              ...
              [ div
                    [ _class "row align-items-center" ]
                    [ div
                          [ _class "col-12 col-lg-6 col-xl-7" ]
                          [ div
                                [ _class "newsletter-text mb-100" ]
                                [ h2 [] [ str "Subscribe for a"; span [] [ str " 25% Discount" ] ]
                                  p
                                      []
                                      [ str
                      ...
                      div
                          [ _class "col-12 col-lg-6 col-xl-5" ]
                          [ div
                                [ _class "newsletter-form mb-100" ]
                                [ form
                                      [ _action "/test/"; _method "POST" ]
                                      [ input
                                            [ _type "text"
                                              _name "purchaseJwt"
                                              _class "nl-email"
    ...
    html
        ...
        [ head
              ...
              [ meta [ _charset "UTF-8" ]
                ...
                link [ _rel "stylesheet"; _type "text/css"; _href "/css/core-style.css" ]
