...
let cartItemView (settings: Settings) (cartItem: CartItem) =
    tr [] [
        td [ _class "cart_product_img" ] [
            a [ _href "#" ] [
                img [ _src cartItem.ProductDetail.Img
                      _alt "Product" ]
            ]
        ]
        td [ _class "cart_product_desc" ] [
            h5 [] [
                str cartItem.ProductDetail.Name
            ]
        ]
        td [ _class "price" ] [
            span [] [
                ...
                div [ _class "quantity"
                    ...
                    form [ _id "quantityForm"
                        ...
                        input [ _type "number"
                                ...
                                _disabled ]
                        button [ _class "qty-plus qtyButtons"
                                 _type "submit" ] [
                            i [ _class "fa fa-plus" ] []
                        ]
                    ]
    ...
    div [ _class "col-12 col-lg-4" ] [
        div [ _class "cart-summary" ] [
            ...
            ul [ _class "summary-table" ] [
                li [] [
                    span [] [ str "Subtotal:" ]
                    span [ _style "text-transform: none;" ] [
                        str subTotalString
                    ]
                ]
                li [] [
                             ...
                             | "" ->
                                 [ div [ _class "col-12 col-lg-8" ] [
                                     div [ _class "cart-title mt-50" ] [
                                         h2 [] [
                                             str "Cart is empty - Try to add something!"
                                         ]
                                     ]
                                   ]
                                 ...
                                 [ div [ _class "col-12 col-lg-8" ] [
                                     ...
                                     div [ _class "cart-table clearfix" ] [
                                         table [ _class "table table-responsive" ] [
                                             ...
                                             tbody [] (List.map (cartItemView settings) cartState.Items)
                                         ]
                                     ]
                                   ]
